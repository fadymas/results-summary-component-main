...
function Result({ loading }) {
  if (loading) {
    return (
      <section className="py-6 flex flex-col items-center rounded-b-[2.125rem] gap-6 lg:gap-8.5 lg:rounded-[1.5rem] lg:py-9.5 bg-gray-100 text-gray-100 lg:w-[calc(753px/2)]">
        <div className="h-6 w-32 bg-gray-200 rounded"></div>
        <div className="result__circle rounded-full flex flex-col justify-center items-center w-35 h-35 lg:w-50 lg:h-50 bg-gray-200">
          <div className="h-10 w-16 bg-gray-200 rounded mb-2"></div>
          <div className="h-4 w-20 bg-gray-200 rounded"></div>
        </div>
        <div className="result__rating-message flex flex-col justify-center items-center gap-2 lg:gap-4 w-65.5">
